...
IDIO_IS_ECHO_BACK           = 8 # echo back output port?         Param1:int(1:true, 0:false)
IDIO_IS_DIRECTION           = 9 # DioSetIoDirection available?   Param1:int(1:true, 0:false)
IDIO_IS_FILTER              = 10 # digital filter available?     Param1:int(1:true, 0:false)
...
DLL.DioInpByte.argtypes = [ctypes.c_short, ctypes.c_short, ctypes.POINTER(ctypes.c_ubyte)]
DLL.DioInpBit.argtypes = [ctypes.c_short, ctypes.c_short, ctypes.POINTER(ctypes.c_ubyte)]
DLL.DioOutByte.argtypes = [ctypes.c_short, ctypes.c_short, ctypes.c_ubyte]
DLL.DioOutBit.argtypes = [ctypes.c_short, ctypes.c_short, ctypes.c_ubyte]
DLL.DioEchoBackByte.argtypes = [ctypes.c_short, ctypes.c_short, ctypes.POINTER(ctypes.c_ubyte)]
DLL.DioEchoBackBit.argtypes = [ctypes.c_short, ctypes.c_short, ctypes.POINTER(ctypes.c_ubyte)]
DLL.DioInpMultiByte.argtypes = [ctypes.c_short, ctypes.POINTER(ctypes.c_short), ctypes.c_short, ctypes.POINTER(ctypes.c_ubyte)]
DLL.DioInpMultiBit.argtypes = [ctypes.c_short, ctypes.POINTER(ctypes.c_short), ctypes.c_short, ctypes.POINTER(ctypes.c_ubyte)]
DLL.DioOutMultiByte.argtypes = [ctypes.c_short, ctypes.POINTER(ctypes.c_short), ctypes.c_short, ctypes.POINTER(ctypes.c_ubyte)]
DLL.DioOutMultiBit.argtypes = [ctypes.c_short, ctypes.POINTER(ctypes.c_short), ctypes.c_short, ctypes.POINTER(ctypes.c_ubyte)]
DLL.DioEchoBackMultiByte.argtypes = [ctypes.c_short, ctypes.POINTER(ctypes.c_short), ctypes.c_short, ctypes.POINTER(ctypes.c_ubyte)]
DLL.DioEchoBackMultiBit.argtypes = [ctypes.c_short, ctypes.POINTER(ctypes.c_short), ctypes.c_short, ctypes.POINTER(ctypes.c_ubyte)]
...
DLL.DioSetDemoByte.argtypes = [ctypes.c_short, ctypes.c_short, ctypes.c_ubyte]
DLL.DioSetDemoBit.argtypes = [ctypes.c_short, ctypes.c_short, ctypes.c_ubyte]
